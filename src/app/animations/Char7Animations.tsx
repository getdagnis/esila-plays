...
const AliseAnimations = ({ animation, id, onDrop, onDragOver, onStop }: AliseAnimationsProps) => {
  ...
  return (
    <div
      ...
      onClick={() => onStop(id)}
    >
      <div id="char7-background" className={styles.animationBackground}></div>
      <img id="char7-teja" className={`${styles.partOnTop}`} src="/characters/alise/alise-teja.svg" alt="" />
      <img id="char7-kermenis" className={styles.partOnTop} src="/characters/alise/alise-kermenis.svg" alt="" />
      <img
        id="char7-galva-bez-mutes"
      ...
      <img
        ...
        alt=""
      />
      <img id="char7-acis-ciet" className={styles.partOnTop} src="/characters/alise/alise-acis-ciet.svg" alt="" />
      <img
        id="char7-kakis"
        className={styles.partOnTop}
        ...
        alt=""
      />
      <img id="char7-mute-ciet" className={`${styles.partOnTop}`} src="/characters/alise/alise-mute-ciet.svg" alt="" />
    </div>
  );
};
...
function resetAll() {
  const background = document.getElementById('char7-background');
  const wrapper = document.getElementById('char7-animations');
  const eyelids = document.getElementById('char7-acis-ciet');
  const tea = document.getElementById('char7-teja');
  const mouth = document.getElementById('char7-mute-ciet');

  const ids = [
    'char7-mute-ciet',
    'char7-galva-bez-mutes',
    'char7-acis-ciet',
    'char7-kermenis',
    'char7-kakis',
    'char7-teja',
...
const drinkTea = (repeat: boolean = true) => {
  const tea = document.getElementById('char7-teja');
  const mouthOpen = document.getElementById('char7-mute-vala');
...
function animateBeat(animation: string) {
  const mouth = document.getElementById('char7-mute-ciet');
  const head = document.getElementById('char7-galva-bez-mutes');
  const eyelids = document.getElementById('char7-acis-ciet');
