...
const AliseAnimations = ({ animation, id, onDrop, onDragOver, onStop }: AliseAnimationsProps) => {
  ...
  return (
    <div
      ...
      onClick={() => onStop(id)}
    >
      <div id="char6-background" className={styles.animationBackground}></div>
      <img id="char6-teja" className={`${styles.partOnTop}`} src="/characters/alise/alise-teja.svg" alt="" />
      <img id="char6-kermenis" className={styles.partOnTop} src="/characters/alise/alise-kermenis.svg" alt="" />
      <img
        id="char6-galva-bez-mutes"
      ...
      <img
        ...
        alt=""
      />
      <img id="char6-acis-ciet" className={styles.partOnTop} src="/characters/alise/alise-acis-ciet.svg" alt="" />
      <img
        id="char6-kakis"
        className={styles.partOnTop}
        ...
        alt=""
      />
      <img id="char6-mute-ciet" className={`${styles.partOnTop}`} src="/characters/alise/alise-mute-ciet.svg" alt="" />
    </div>
  );
};
...
function resetAll() {
  const background = document.getElementById('char6-background');
  const wrapper = document.getElementById('char6-animations');
  const eyelids = document.getElementById('char6-acis-ciet');
  const tea = document.getElementById('char6-teja');
  const mouth = document.getElementById('char6-mute-ciet');

  const ids = [
    'char6-mute-ciet',
    'char6-galva-bez-mutes',
    'char6-acis-ciet',
    'char6-kermenis',
    'char6-kakis',
    'char6-teja',
...
const drinkTea = (repeat: boolean = true) => {
  const tea = document.getElementById('char6-teja');
  const mouthOpen = document.getElementById('char6-mute-vala');
...
function animateBeat(animation: string) {
  const mouth = document.getElementById('char6-mute-ciet');
  const head = document.getElementById('char6-galva-bez-mutes');
  const eyelids = document.getElementById('char6-acis-ciet');
