...
const AliseAnimations = ({ animation, id, onDrop, onDragOver, onStop }: AliseAnimationsProps) => {
  ...
  return (
    <div
      ...
      onClick={() => onStop(id)}
    >
      <div id="char5-background" className={styles.animationBackground}></div>
      <img id="char5-teja" className={`${styles.partOnTop}`} src="/characters/alise/alise-teja.svg" alt="" />
      <img id="char5-kermenis" className={styles.partOnTop} src="/characters/alise/alise-kermenis.svg" alt="" />
      <img
        id="char5-galva-bez-mutes"
      ...
      <img
        ...
        alt=""
      />
      <img id="char5-acis-ciet" className={styles.partOnTop} src="/characters/alise/alise-acis-ciet.svg" alt="" />
      <img
        id="char5-kakis"
        className={styles.partOnTop}
        ...
        alt=""
      />
      <img id="char5-mute-ciet" className={`${styles.partOnTop}`} src="/characters/alise/alise-mute-ciet.svg" alt="" />
    </div>
  );
};
...
function resetAll() {
  const background = document.getElementById('char5-background');
  const wrapper = document.getElementById('char5-animations');
  const eyelids = document.getElementById('char5-acis-ciet');
  const tea = document.getElementById('char5-teja');
  const mouth = document.getElementById('char5-mute-ciet');

  const ids = [
    'char5-mute-ciet',
    'char5-galva-bez-mutes',
    'char5-acis-ciet',
    'char5-kermenis',
    'char5-kakis',
    'char5-teja',
...
const drinkTea = (repeat: boolean = true) => {
  const tea = document.getElementById('char5-teja');
  const mouthOpen = document.getElementById('char5-mute-vala');
...
function animateBeat(animation: string) {
  const mouth = document.getElementById('char5-mute-ciet');
  const head = document.getElementById('char5-galva-bez-mutes');
  const eyelids = document.getElementById('char5-acis-ciet');
